  ...
  return (
    <section id="about" className="about-us-section">
      ...
      <div className="about-us-images">
        <img
          src="https://img.freepik.com/premium-photo/al-fresco-dining-mediterranean-restaurant-inviting-outdoor-dinner-setting-vertical-mobile-w_896558-43062.jpg"
          alt="Outdoor Dining"
        />
        <img
          src="https://www.shutterstock.com/image-photo/chef-cooks-seafood-fry-shrimps-600nw-1584930799.jpg"
          alt="Chef Cooking"
        />
      </div>
    </section>
